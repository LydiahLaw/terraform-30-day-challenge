...
resource "aws_security_group" "instance_sg" {
  name        = "terraform-day05-instance-sg"
...
resource "aws_launch_template" "web" {
  ...
  user_data = base64encode(<<-EOF
              ...
              echo "<h1>Hello from Terraform - Day 05 Cluster</h1>" > /var/www/html/index.html
              EOF
  )
}
...
resource "aws_autoscaling_group" "web" {
  ...
  tag {
    key                 = "Name"
    value               = "terraform-day05-asg-instance"
